...
<div style:width={`${width}px`}>
    <h3 class="text-xl mb-2">Mode Chart All in One</h3>
    <div>
    ...
    <p>
        This is not ideal. I need a legend per chart.
        I think the better method is that each mode point gets its own bar with legend and no axis, and the 'container' for the mode chart has the axis as independent visual element.
    </p>
</div>